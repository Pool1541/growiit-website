...
const EmblaCarousel: React.FC<PropType> = (props) => {
  ...
  const applyStylesToSlides = useCallback(
    (emblaApi: EmblaCarouselType) => {
      ...
      slideNodes.forEach((slideNode, index) => {
        if (index === centerSlideIndex) {
          ...
          document
            .querySelector('main')!
            .style.setProperty('--custom-article-bg-color', customColor);
          document
            .querySelector('main')!
            .style.setProperty('--custom-article-dark-color', darkColor);
    ...
    <div className='embla'>
      ...
      <div className='embla__controls'>
        <PrevButton
          ...
          className='embla__button embla__button--prev embla__button--small'
        />
        ...
        <NextButton
          ...
          className='embla__button embla__button--next embla__button--small'
        />
      </div>
    </div>
  );
